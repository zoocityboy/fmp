abstract class Constants {
  ...
  static const String vscodeFolder = '.vscode';
  static const String vscodeRenamedFolder = '.vscode_gmat_hidden';

  ///
  static const String expressServerTpl = 'server.js';
  static const String expressServerPackageTpl = 'package.json';
  ...
  static const String argBootstrapServerBuild = 'server-build';
  static const String argBootstrapServerRun = 'server-run';
  static const String argBootstrapInstallExtensions = 'extensions';
  static const String argBootstrapRefresh = 'refresh';
}

abstract class CommandKeys {
  static const String nodeJsExec = 'node';
  static const String npmExec = 'npm';
  static const String vscodeExec = 'code';
  static const String vscodeExtension = '.vsix';
}
